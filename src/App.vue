<template>
  <div class="app">
    ...
    <div class="pageDiv container" style="background-color:#fff;">
      ...
      <footer class="footer">
        ...
        <div class="concat-link">
          <template v-for="item in concats">
            <a v-if="item.type!=='wx'" :href="item.link" target="_blank">
              <img
                :src="item.src"
                width="25"
                height="25"
            ...
            <a class="weixin" v-if="item.type==='wx'" href="javascript:;">
              <img
                class="weixin-qrcode"
                width="100"
                height="100"
      ...
      <div class="donation">捐赠我们:AU6WPAYiTFtay8QJqsYVGhZ6gbBwnKPxkf</div>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      concats: [
        {
          link: "https://github.com/OTCGO/website",
          src: require("~images/svgs/Github.svg"),
          desc: "Github"
        },
        {
          link:
            "//shang.qq.com/wpa/qunwpa?idkey=084887ec4235e85c771e41797f3360ae4be6f50b82d410e5e5d6890e11966d86",
          src: require("~images/svgs/QQ.svg"),
          desc: "QQ"
        },
        {
          link: "",
          src: require("~images/svgs/wx.svg"),
          desc: "wx",
          type: "wx",
          qrCode: require("~images/wx-QRcode.jpg")
        },
        {
          link: "//t.me/otcgo",
